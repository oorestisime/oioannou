...
export const meta: MetaFunction<typeof loader> = ({ data }) => {
  ...
  return [
    ...
    { name: "description", content: `Explore blog posts tagged with "${data.tag}" by Orestis Ioannou` }
  ];
};
...
export function loader({ params }: LoaderFunctionArgs) {
  ...
  const actualTag = posts[0].tags?.find(t => t.toLowerCase() === tag.toLowerCase()) || tag;
